...
from src.app.config import settings, SUPPORTED_CONVERSIONS
from src.app.db.redis_client import set_job
from src.app.models.job import JobStatus, JobResponse
from src.app.worker.celery_app import celery_app
...
async def convert_document(
    ...
    celery_app.send_task(
        "src.worker.tasks.convert_document",
